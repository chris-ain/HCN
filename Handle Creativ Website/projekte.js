...
if(!useNativeScroll) {
    ...
    void main() {
        ...
        vec2 redTextCoords = vec2(vTextureCoord.xy  + uScrollEffect / 4000.0);
        vec2 greenTextCoords = vec2(vTextureCoord.xy + uScrollEffect / 30000.0);
        vec2 blueTextCoords = vec2(vTextureCoord.xy+ uScrollEffect / 30000.0);
